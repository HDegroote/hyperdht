...
function matchAddress (localAddresses, remoteLocalAddresses) {
  ...
  remoteLocalAddresses = [...remoteLocalAddresses].filter(a => !a.host.startsWith('172.17')) // Filter out probably docker addresses
  console.log('filtered:', remoteLocalAddresses)
